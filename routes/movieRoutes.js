...
import { createMovie, deleteMovieById, getAllMovieQuery, getAllMovies, getMovieById, updateMovieById } from '../controller/movieController.js'
...
movieRoutes.get('/query', getAllMovieQuery)
